  ...
  return (
    <>
      ...
      <div className='flex container px-4'>
        <div className='w-full rounded-xl mb-10 flex items-start justify-between bg-bgtheree px-8 py-8 dark:bg-lite max-xl:flex-col gap-10 px-32  max-sm:px-4'>
          <div>
          ...
          <div className='flex gap-14 flex-col items-start mr-14'>
